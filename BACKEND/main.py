...
def main():
    ...
    if art_style not in valid_styles:
        print("⚠️ Invalid style! Defaulting to 'Anime'")
        art_style = "Anime"
    ...
    # Verify if images were generated successfully
    ...
    # Step 6: Create final comic strip with text
    print("\n🖼️ Creating the final comic strip...")
    
    # Path for the final output image
    output_path = os.path.join(OUTPUT_FOLDER, "comic_strip_with_text.png")

    # ✅ Pass image file paths instead of PIL image objects
